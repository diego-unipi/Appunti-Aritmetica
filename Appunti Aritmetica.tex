...
\begin{remark}
[Spazi Vettoriali]
Un gruppo abeliano $(V,+)$ si dice \vocab{spazio vettoriale} sul campo $K$ se esiste un'appliazione:
...
\begin{definition}
Dato un campo $K$ ed una sua estensione $F$, $\alpha \in F$ si dice \vocab{trascendete} su $K$ se non è algebrico, ovvero:
